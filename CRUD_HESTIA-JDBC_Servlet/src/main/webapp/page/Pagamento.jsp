...
<form action="Pagamento-Servlet" ></form>
    <h1>Tabela Pagamento</h1>
<form action="Inserir-Pagamento-Servlet"><button class="Botao" type="submit"><a>Criar</a></button> </form>
